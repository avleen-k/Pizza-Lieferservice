...
public class PizzaImpl implements Pizza{
    ...
    private double diametar;
    private String sauce;

    public PizzaImpl(BigDecimal price, double weight, IceCream.Variant<?,?> foodVariant, List<? extends Extra<?>> extras, double diametar, String sauce)
    {
        this.price = price;
        this.weight = weight;
